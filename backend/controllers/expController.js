...
const deleteExpense = async (req, res) => {
  try {
    ...
    // Update the category's totalExpense
    const category = await Category.findOne({ name: expense.category, userId: req.user.id });
    category.totalExpense -= expense.amount;
    await category.save();
...
module.exports = { getExpenses, createExpenses, deleteAllExpenses, deleteExpense };